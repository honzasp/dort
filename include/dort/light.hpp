...
namespace dort {
  ...
  public:
    ...
    /// Samples a point on the light, if possible.
    /// For lights that have no geometry (such as background lights), returns
    /// false, otherwise initializes out_p, out_nn and out_pos_pdf. The normal
    /// out_nn may be initialized to 0 in case of point lights.
